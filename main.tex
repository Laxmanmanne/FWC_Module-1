...
\item In \figref{fig:sectorofcircle}, is shown a sector $OAP$ of a circle with center $O$, containing $\angle \theta$. $AB$ is perpendicular to the radius $OA$ and meets $OP$ produced at $B$. Prove that the perimeter of the shaded region is $r[tan\theta + sec\theta +\frac{\pi\theta}{180}]$
    \begin{figure}[H]
